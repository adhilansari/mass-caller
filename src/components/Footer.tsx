        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#features" className="text-gray-600 hover:text-caller-blue dark:text-gray-300 dark:hover:text-caller-purple">
                  Features
                </a>
              </li>
              <li>
                <a href="#pricing" className="text-gray-600 hover:text-caller-blue dark:text-gray-300 dark:hover:text-caller-purple">
                  Pricing
                </a>
              </li>
              <li>
                <a href="#how-it-works" className="text-gray-600 hover:text-caller-blue dark:text-gray-300 dark:hover:text-caller-purple">
                  How It Works
                </a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-caller-blue dark:text-gray-300 dark:hover:text-caller-purple">
                  Enterprise
                </a>
              </li>
            </ul>
